...
class BaseOptions(object):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--eval_dir', default='./Model_all/', help='Path to use checkpoint models')
        ...
        self.parser.add_argument('--net', default='resnet50', type=str,
                                 choices=['vgg', 'vgg_bn', 'resnet50', 'resnet101','MobileNetV3_Small','MobileNetV3_Large'],
        ...
        self.parser.add_argument('--test_size', default=(640, 640), type=int, help='model input size')
