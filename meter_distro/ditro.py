...
class MeterReader_distro(object):
    ...
    def __call__(self, image, image_name):
        ...
        # cv2.waitKey(0)
        # print("cnt",len(cnt))
        # cv2.imwrite("pre_exp/img.jpg", image)
        # cv2.imwrite("pre_exp/src.jpg", meter_mask)
        # cv2.imwrite("pre_exp/src1.jpg", cnt_image)
    ...
    def read_image(self,ori_img, mask_img):
        ...
        cnt, cont_image = cv2.findContours(a, cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE)
    ...
    def visulization(self,ori, new,image_name):
        ...
        # cv2.imwrite("pre_exp/det1.jpg", output)
